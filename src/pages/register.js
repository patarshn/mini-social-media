...
export default function Register() {
    ...
    <div className="flex-1 flex items-center justify-center bg-black">
      <div className="w-full max-w-md p-6 shadow-md">
        ...
        <form>
          <div className="mb-4">
            <label for="username" className="block text-white font-medium mb-2 focus:border-gradient-to-r focus:border-from-green-500 focus:border-to-sky-500">Username</label>
            <input type="text" id="username" className="input input-bordered rounded-full w-full" placeholder="Enter your username"/>
          </div>
          <div className="mb-4">
          ...
          <div className="flex items-center justify-center pt-2">
            <span className="text-white">Already have account? <Link href={"/login"} className="text-extrabold bg-gradient-to-r from-pink-500 to-yellow-500 inline-block text-transparent bg-clip-text hover:from-green-500 hover:to-sky-500">Login Here</Link> </span>
          </div>
        </form>
      </div>
    </div>
