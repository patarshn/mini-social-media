    ...
    switch (req.method) {
        case 'GET':
            ...
            try {
                ...
                const users = await User.findOne({username: searchUsername}).populate('following', '_id username email');
                ...
                return responseWrapper({ res, status: 200, message: `${prefix}: Success Get following`, error: false, data })
            } catch (error) {
